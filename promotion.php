...
$id_cat=$_GET['id_cat'];
$page=$_GET['page'];
$sql3="select * from product WHERE promotion='1' order by name "; 
...
<table border="1" width="100%" bgcolor="#0000FF" id="table1">
	<tr>
		<td>
		<p align="center"><font color="#FFFF00" size="4">สินค้าโปรโมชั่น มี  
    ...
    if ($num==1) {echo"<tr>";}
     echo "
      ...
      echo"
		...
		ชื่อสินค้า :<b>$name</b><br>ราคาปกติ : <b>$price</b> บาท<br>ราคาโปรโมชั่น : <font color=\"#FF0000\"><font size=\"4\"><b>$price_pro</b></font></font> บาท !!!!
		<form action=\"promotion2.php?id=$id\" method=\"post\">
