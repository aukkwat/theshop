...
$act=$_GET['act'];
$page=$_GET['page'];
$sql2="select * from product WHERE id_cat='$id_cat' and promotion='0' "; 
...
<div align="center">
	<table border="1" width="90%" id="table2">
		<tr>
			...
			<u>
			<b>รายการสินค้าปกติ มี <?=$total_price?> รายการ</b></u></font><font size="4" color="#FFFF00"> </font>
   ...
   <table border="1" width="90%" id="table3">
		<tr>
			<td align="center" bgcolor="#808080"><b>หมวดสินค้า: <?=$name?></b></td>
		</tr>
	</table>
...
echo"
		<tr>
			...
			<a href=\"product2.php?id_cat=$id_cat&id_product=$id_product&act=delete&page=$page\" title=\"ลบสินค้ารายการนี้\">
